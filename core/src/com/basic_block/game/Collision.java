...
//		}
	...
	public static int fixIntersection(DynamicEntity d, Entity e, float delta) {
...
//		dCornerY -= delta * d.getDY();
	...
	private static int adjustX(DynamicEntity d, Entity e) {
		float dx = d.getDX();
		d.setDX(0);
		if(dx > 0) {
	...
	private static int adjustY(DynamicEntity d, Entity e) {
		float dy = d.getDY();
		d.setDY(0);
		if(dy > 0) {
